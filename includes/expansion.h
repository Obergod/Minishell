...
# include "wildcard.h"
// Forward declarations pour éviter les conflits de types
struct s_redir;
struct s_minishell;
...
int		remove_quotes_redirs(struct s_redir *redirs, struct s_minishell *minishell);
...
void	process_dollar(char *str, t_exp_data *data, struct s_minishell *minishell);
...
char	**remove_quotes_array(char **tokens, struct s_minishell *minishell);
